...
// Helper function: shuffle a list
...
ScoreCalculator.prototype.generateRewardOptions = function(found_list)
{
    ...
    var options = [
    {'id': 0, 'split': this.roundDown(this.proportionalSplit(found_list))},
    {'id': 1, 'split': this.roundDown(this.adjustSplit(this.proportionalSplit(found_list), 0, 1))},
    {'id': 2, 'split': this.roundDown(this.adjustSplit(this.proportionalSplit(found_list), 1, 1))},
    {'id': 3, 'split': this.roundDown(this.adjustSplit(this.proportionalSplit(found_list), 2, 1))},
    ];
