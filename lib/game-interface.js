...
function WordSearchScoreScreen()
{
    
}

WordSearchScoreScreen.prototype.initialize = function()
{
    
}

WordSearchScoreScreen.prototype.render = function()
{
    // Set up the HTML structure of the lobby
    var html_string = "";
    html_string += '<div id="lobby-container">';
    html_string += '<div class="lobby-title">Game Over! Final Score:</div>';
...
function WordSearchInterface() 
{
    ...
    // Score screen object
    //this.score_screen = new WordSearchScoreScreen();
}
...
WordSearchInterface.prototype.postInitialize = function()
{
    ...
    var start_function = this.startGame.bind(this);
    this.lobby.initialize(this.client, this.player_id, start_function);
