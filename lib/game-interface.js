...
WordSearchGrid.prototype.getScore = function()
{
    ...
    {
        var num_found = 
            this.words[i + 0*words_per_player]['found'] + 
            this.words[i + 1*words_per_player]['found'] + 
            this.words[i + 2*words_per_player]['found'];

        score += score_per_line[num_found];
    }
